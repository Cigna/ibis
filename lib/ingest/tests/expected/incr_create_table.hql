...
INSERT OVERWRITE TABLE `domain.database_test_table_test` PARTITION(incr_ingest_timestamp) SELECT CAST(`FAKE_COL_1` AS CHAR(3)) AS `FAKE_COL_1`,
...
'20160101164756' AS `incr_ingest_timestamp` FROM `parquet_stage.database_test_table_test`;
