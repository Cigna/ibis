...
INSERT OVERWRITE TABLE `parquet_stage.database_test_table_test` partition(incr_ingest_timestamp='full_20160101164756') SELECT CAST(`FAKE_COL_1` AS CHAR(3)) AS `FAKE_COL_1`,
